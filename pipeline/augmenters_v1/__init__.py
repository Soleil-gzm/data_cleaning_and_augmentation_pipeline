...
# 注册（含别名以兼容旧配置里的 similarword / similarword 等名字）
AugmenterRegistry.register(
    "synonym_replace", SynonymAugmenter, aliases=("similarword", "synonym")
)
...
AugmenterRegistry.register(
    "random_entity_replace", RandomEntityReplaceAugmenter, aliases=("entity_replace",)
)
