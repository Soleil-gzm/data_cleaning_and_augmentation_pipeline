...
# ========== 配置 ==========
INPUT_JSON = "task_20260429/raw_data/data-record-processed-92049-filter.json"   # 原始 JSON 文件路径
OUTPUT_DIR = "task_20260429/task_92049/output_cleaning/samples"                        # 输出目录
STATS_DIR = "task_20260429/task_92049/output_cleaning/stats"                           # 统计轮次分布文件目录
PROGRESS_FILE = "task_20260429/task_92049/output_cleaning/progress.txt"                # 进度文件
